 ...
 * del tipo apropiado y de la zona indicada, en el momento de la compra se
 * asignará a la entrada un identificador (un número entero) que permitirá la
